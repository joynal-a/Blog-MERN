                    ...
                    <div className="d-flex justify-content-end   w-100">
                      <ul className="navbar-nav">
                        <li className="nav-item">
                          <a className="nav-link" href="www.dfd.com">Link</a>
                        </li>
                        <li className="nav-item">
                          <span className="nav-link" data-bs-toggle="modal" data-bs-target="#ModalRegister">Register</span>
                        </li>
                        <li className="nav-item">
                          <span className="nav-link" data-bs-toggle="modal" data-bs-target="#ModalLogin" ref={secondButtonRef} onClick={handleSecondButtonClick}>Login</span>
                        </li>
